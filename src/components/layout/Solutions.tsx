...
const Solutions = () => {
    ...
    return (
        <>
            <div className="z-[50] bg-[--black-1000] grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 justify-center items-start w-full h-full p-4 sm:p-4 md:p-8 lg:p-8 xl:p-8 gap-6 sm:gap-6 md:gap-8 lg:gap-8 xl:gap-8 overflow-hidden">
                <Tilt className="z-[10] hidden sm:hidden md:block lg:block xl:block !size-full"
                    tiltMaxAngleX={2}
                    tiltMaxAngleY={2}
                    glareEnable={true}
                ...
                <div className="z-[10] block sm:block md:hidden lg:hidden xl:hidden !size-full">
                    <div className="group block items-start size-full bg-gradient-to-t from-[--black-800] to-[--black-600] border border-[--black-400] rounded-xl overflow-hidden cursor-pointer">
                        <div className="block items-start w-full h-auto p-6 sm:p-6 md:p-8 lg:p-8 xl:p-8">
                            <div className="flex justify-start items-center w-max px-2.5 py-2 space-x-1 leading-none text-sm text-[#45b4ff] border border-[#45b4ff] rounded-full select-none" id="sec2_chip1">
                                <BoltIcon className="flex justify-center items-center size-3.5" />
                ...
                <div className="z-[10] block justify-start items-center size-full">
                    <Tilt className="z-[10] hidden sm:hidden md:block lg:block xl:block !w-full !h-auto"
                        tiltMaxAngleX={2}
                        tiltMaxAngleY={2}
                        glareEnable={true}
                        glareBorderRadius='10px'
                        ...
                        glareColor='#57d365'
                    >
                        <div className="z-[10] group block items-start w-full h-full bg-gradient-to-t from-[--black-800] to-[--black-600] border border-[--black-400] rounded-xl overflow-hidden cursor-pointer">
                    ...
                    <Tilt className="z-[10] hidden sm:hidden md:block lg:block xl:block !w-full !h-auto mt-6 sm:mt-6 md:mt-8 lg:mt-8 xl:mt-8"
                        tiltMaxAngleX={2}
                        tiltMaxAngleY={2}
                        glareEnable={true}
                        glareBorderRadius='10px'
                        ...
                        glareColor='#ffd33d'
                    >
                        <div className="z-[10] group relative flex justify-center items-center w-full h-full bg-gradient-to-t from-[--black-800] to-[--black-600] border border-[--black-400] rounded-xl overflow-hidden cursor-pointer">
