...
const Solutions = () => {
    ...
    return (
        <>
            <div className="z-[50] bg-[--black-1000] flex justify-center items-start w-full h-full">
                <div className="z-[50] bg-[--black-1000] grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 justify-center items-start w-full h-full p-4 sm:p-4 md:p-8 lg:p-8 xl:p-8 gap-6 sm:gap-6 md:gap-8 lg:gap-8 xl:gap-8">
                    <Tilt className="z-[50] hidden sm:hidden md:block lg:block xl:block size-full bg-[--black-1000]"
                        tiltMaxAngleX={2}
                        tiltMaxAngleY={2}
                        glareEnable={true}
                    ...
                    <div className="z-[50] block sm:block md:hidden lg:hidden xl:hidden size-full bg-[--black-1000]">
                    ...
                    <div className="z-[50] block justify-start items-center size-full bg-[--black-1000]">
                        ...
                        >
                            <div className="group relative flex justify-center items-center w-full h-full bg-gradient-to-t from-[--black-1000] to-[--black-900] border border-[--black-600] rounded-md overflow-hidden cursor-pointer">
                                ...
                                <div className="z-[0] absolute -right-24 flex justify-center items-center size-[20rem] -rotate-6 opacity-20">
                                    <Image className="flex justify-center items-center size-full"
