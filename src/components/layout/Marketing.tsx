...
const Marketing = () => {
    ...
    return (
        <>
            <div className="z-[10] flex justify-center items-center w-full h-auto sm:h-auto md:h-[32rem] lg:h-[32rem] xl:h-[32rem] bg-[--black-1100] text-[--white-100] f-dmsans">
                <div className="z-[10] block sm:block md:flex lg:flex xl:flex items-center size-full bg-[--black-1100] border-t border-[--black-600]">
                    ...
                    <div className="flex justify-center items-center w-full sm:w-full md:w-1/2 lg:w-1/2 xl:w-1/2 h-auto sm:h-auto md:h-full lg:h-full xl:h-full py-5 sm:py-5 md:py-0 lg:py-0 xl:py-0 bg-gradient-to-t from-[--black-1100] to-[--black-900]">
                        <Image className="flex justify-center items-center w-[24rem]"
