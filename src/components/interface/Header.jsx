...
const Header = () => {
  ...
  return (
    <>
      <div className="z-[900] absolute top-0 hidden sm:hidden md:flex lg:flex xl:flex justify-between items-center w-full h-14 px-2 text-white bg-none x_shadow-c-sub-nav">
