...
export const GoogleGeminiEffect = ({
    ...
    return (
        <div className={cn("sticky", className)}>
            <div className="flex flex-col justify-center items-center w-full h-auto -mt-[6rem] text-white bg-[--black-1100]">
            ...
            <svg
                ...
                className=" absolute !-top-[11.8rem] w-full overflow-visible"
            >
                <motion.path
